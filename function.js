...
class Game {
  ...
  startGame() {
    if (computer.signs[0].style.backgroundColor == "gray" || computer.signs[1].style.backgroundColor == "gray" || computer.signs[2].style.backgroundColor == "gray") {
      for (let i = 0; i < 3; i++) {
        player1.signs[i].style.backgroundColor = "rgba(156, 131, 95, 1)";
        computer.signs[i].style.backgroundColor = "rgba(156, 131, 95, 1)";
      }
      ...
      let intervalGenerator = setInterval(() => {
        ...
        if (timesRun > 0) {
          this.player2.signs[signIdxBefore].style.backgroundColor = "rgba(156, 131, 95, 1)";
        }
